...
use gammaeditor_lib::save::pokemon::attack_lists::{attack_array, attack_at, attacks_at, parse_attack};
...
fn parse_attack_parses() {
    let actual = parse_attack("/Game/BPS/ABILITIES/BuffSkills/GHOST/Astonish/BP_Astonish.BP_Astonish_C").expect("parsed");
